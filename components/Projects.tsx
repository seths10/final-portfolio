...
export default function Projects({ projects }: Props) {
  return (
    ...
    mx-auto items-center z-0'>
      ...
      <div className='relative w-full flex overflow-x-scroll scrollbar-track-gray-400/5 scrollbar-thin scrollbar-thumb-[#F7AB0A]/80 overflow-y-hidden snap-x snap-mandatory z-20'>
          ...
          <div
           ...
           p-20 md:p-44 h-screen'>
            <motion.img
              ...
              viewport={{ once: true }}
              src={urlFor(project?.image).url()} alt="projects" />
            ...
            <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
              ...
              <div className='flex items-center space-x-2 justify-center'>
                {project?.technologies.map((technology) => (
                  <img className='h-10 w-10' key={technology._id} src={urlFor(technology?.image).url()} alt="tech-stack" />
                ))}
              </div>
