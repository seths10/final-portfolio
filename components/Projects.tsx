...
export default function Projects({ }: Props) {
  ...
  return (
    ...
    mx-auto items-center z-0'>
      ...
      <div className='relative w-full flex overflow-x-scroll scrollbar scrollbar-track-gray-400/5 scrollbar-thin scrollbar-thumb-[#F7AB0A]/80 overflow-y-hidden snap-x snap-mandatory z-20'>
           ...
           p-20 md:p-44 h-screen'>
            ...
            <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
              ...
              <p className='text-lg text-center md:text-left'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit quae modi nulla pariatur repellat exercitationem distinctio, rem beatae obcaecati enim!
              </p>
            </div>
          </div>
